...
namespace EF_Demo.Controllers
{
    public class StudentModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Department")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Department")] StudentModel studentModel)
        {
